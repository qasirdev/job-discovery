# SKILLS — JobServe Agent

This file describes the domain-specific skills and heuristic abilities available to the JobServe Agent.

## 1. DOM Pattern Matching
- Identify standard JobServe CSS selectors for job panels and description bodies.
- Handle fallback selectors when standard JobServe layouts change dynamically.
