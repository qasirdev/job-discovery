...
class UserProfile(Base):
    ...
    skills: Mapped[list[str]] = mapped_column(JSONB, default_factory=list)
    years_experience: Mapped[int] = mapped_column(Integer)
    cv_filename: Mapped[str | None] = mapped_column(String, default=None)
    
    target_roles: Mapped[list[str]] = mapped_column(JSONB, default_factory=list)
    preferred_stack: Mapped[list[str]] = mapped_column(JSONB, default_factory=list)
